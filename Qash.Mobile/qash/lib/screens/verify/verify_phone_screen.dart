...
import '../../features/auth/models/verify_phone_request.dart';
...
class _VerifyPhoneScreenState extends ConsumerState<VerifyPhoneScreen> {
  ...
  Future<void> _verify() async {
    ...
    final response = await api.verifyPhone(
      VerifyPhoneRequest(phoneNumber: phone, verificationCode: code),
    );
    ...
    if (response.success) {
      _showMessage('Phone verified. Please sign in.');
      context.go('/login');
    } else {
      _showMessage(
