...
import '../domain/usecases/get_wallet_by_id_use_case.dart';
...
final getWalletByIdUseCaseProvider = Provider<GetWalletByIdUseCase>((ref) {
  return GetWalletByIdUseCase(ref.read(walletsRepositoryProvider));
});
...
final walletByIdProvider = FutureProvider.family<Result<WalletEntity>, String>((
  ref,
  walletId,
) async {
  final useCase = ref.read(getWalletByIdUseCaseProvider);
  return useCase(walletId);
});
